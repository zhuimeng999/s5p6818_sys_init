...
void printClkInfo(void) {
	uart_printf(" PLL0: %d   PLL1: %d   PLL2: %d   PLL3: %d\r\n\r\n",
			pll_clk_pll_get_freq(PLL_INDEX_0),
			pll_clk_pll_get_freq(PLL_INDEX_1),
			pll_clk_pll_get_freq(PLL_INDEX_2),
			pll_clk_pll_get_freq(PLL_INDEX_3));
	...
	uart_printf(" Divider1 PLL: %d BCLK:%d   PCLK:%d\r\n",
			pll_clk_sys_get_src(1), pll_clk_sys_get_bclk_freq(1),
			pll_clk_sys_get_pclk_freq(1));
